              ...
              <div class="mt-3 sm:mt-5">
                ...
                <div class="mt-2">
                  <p class="text-xsm text-gray-500">
                    Le cloud a bouleversé le marché de l’informatique apportant
                    de nouvelles opportunités et des nouveaux modèles en matière
                    de services. <br />
                    <br />
                    Les process opérationnels d’exploitation s’invitent dans les
                    développements (DevOps), dans la mise en œuvre de la
                    sécurité (SecOps), les budgets s’élaborant sous de multiples
                    dimensions (FinOps). <br />
                    Pour mieux vous aider et fort de nos 20 ans d’expérience,
                    nous avons repensé nos méthodes et services ainsi que notre
